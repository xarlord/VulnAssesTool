...
<meta
  ...
  content="default-src 'self'; script-src 'self'; connect-src 'self' https://services.nvd.nist.gov https://api.osv.dev; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:;"
/>
```
