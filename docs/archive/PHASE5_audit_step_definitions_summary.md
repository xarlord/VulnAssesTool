...
**Vulnerability Operations** 4. ✅ Log vulnerability scan
...
**SBOM Operations** 6. ✅ Log SBOM upload
...
**Settings Operations** 8. ✅ Log settings change
...
**Profile Operations** 9. ✅ Log profile creation
...
**Export Operations** 12. ✅ Log export event - Given: 10 vulnerabilities are exported as PDF - When: Export is logged - Then: Audit event with action "EXPORT", new state contains format "pdf", item count is 10

**Bulk Operations** 13. ✅ Log bulk delete operation - Given: 5 projects are selected for bulk deletion - When: Bulk delete is executed - Then: Audit event with action "DELETE", metadata indicates bulk operation, affected IDs recorded
